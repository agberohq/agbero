...
func (c *ConfigHelper) Validate(configFile string) error {
...
func (c *ConfigHelper) Reload(configFile string) error {
	global, err := loadGlobal(configFile)
	if err != nil {
...
func (c *ConfigHelper) Path(configFile string) {
	fmt.Println(configFile)
}

func (c *ConfigHelper) View(configFile, editor string) {
	if editor != "" {
...
func (c *ConfigHelper) Edit(configFile string) {

...
type TTLPolicy struct {
	Enabled expect.Toggle `hcl:"enabled,attr" json:"enabled"`
	Default Duration      `hcl:"default,attr" json:"default,omitempty"`

	// Content-aware TTL overrides (prefix match on Content-Type)
	ContentType map[string]Duration `hcl:"content_type,attr" json:"content_type,omitempty"`

	// Extension-based fallbacks (e.g., .rss, .pdf)
	Extension map[string]Duration `hcl:"extension,attr" json:"extension,omitempty"`
